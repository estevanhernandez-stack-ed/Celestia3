...
export const PLANET_CONFIGS: Record<string, { color: string; size: number; baseDistance: number }> = {
  "Sun": { color: "#FFD700", size: 1.2, baseDistance: 0 },
  "Moon": { color: "#F5F5F5", size: 0.5, baseDistance: 10 },
  "Mercury": { color: "#A9A9A9", size: 0.3, baseDistance: 15 },
  "Venus": { color: "#E9967A", size: 0.5, baseDistance: 20 },
  "Mars": { color: "#FF4500", size: 0.45, baseDistance: 25 },
  "Jupiter": { color: "#DAA520", size: 0.9, baseDistance: 35 },
  "Saturn": { color: "#F4A460", size: 0.8, baseDistance: 45 },
  "Uranus": { color: "#AFEEEE", size: 0.6, baseDistance: 55 },
  "Neptune": { color: "#4169E1", size: 0.6, baseDistance: 65 },
  "Pluto": { color: "#DCDCDC", size: 0.2, baseDistance: 75 },
};
...
// Simplified star maps for zodiac constellations (relative offsets)
