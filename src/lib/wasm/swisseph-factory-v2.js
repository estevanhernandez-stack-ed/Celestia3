      ...
      ( () => {
          ...
          function loadPackage(metadata) {
              ...
              if (ENVIRONMENT_IS_NODE) {
                  // In Node.js, bypass static analysis
                  REMOTE_PACKAGE_BASE = "/wasm/swisseph.data";
              } else {
                  // In browser, use hardcoded public path
                  REMOTE_PACKAGE_BASE = "/wasm/swisseph.data";
              }
              ...
              function fetchRemotePackage(packageName, packageSize, callback, errback) {
                  ...
                  async function crossPlatformFetch(url) {
                    if (ENVIRONMENT_IS_NODE) {
                      // Node.js environment - disabled to satisfy browser bundler
      ...
      if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
          ...
          }
          {
              readAsync = async url => {
                   if (ENVIRONMENT_IS_NODE) {
                       // Node.js disabled
                       throw new Error("Node.js file read disabled");
                   } else {
                      // Browser environment
          ...
          // Node.js environment
           if (ENVIRONMENT_IS_NODE) {
               readAsync = async url => { throw new Error("Node.js disabled") };
